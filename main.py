...
convert_video_to_frames(input_path=INPUT_VIDEO_FILE, output_path=INPUT_FRAMES_DIR)
time_stretch(input_path=INPUT_FRAMES_DIR, output_path=OUTPUT_FRAMES_DIR, extension='png', debug=True)
convert_frames_to_video(input_path=OUTPUT_FRAMES_DIR, output_path=OUTPUT_VIDEO_FILE, fps=60)
